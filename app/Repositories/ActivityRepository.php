...
class ActivityRepository
{
    ...
    public function getListOfActivitiesPerUser($where = null)
    {
        ...
        $activityList->select('uu.manager_id AS manager_id','m.name AS manager_name', 'temp_a.user_id AS user_id', 'u.name AS user_name', 'u.country AS user_country', 'u.employee_type AS user_employee_type', 'u.domain AS user_domain','u.management_code','u.activity_status',
        ...
        //active and europe 
        if ($where['active_cons'] == 1) {
            $activityList->where('u.activity_status', 'active');
        }

        if ($where['europe_cons'] == 1) {
            $activityList->where(function($activityList) {
        $activityList->where('u.management_code','=','DPS22')
    ...
    public function list_gaps($where = null)
    {
        // code...
