...
class ActivityRepository
{
  ...
  public function getListOfActivitiesPerUser($id,$year)
  {
    ...
    **/
      /*$activityList = DB::table('activities')
      ->select( 'u2.id as manager_id','u2.name as manager_name','u.id as employee_id','u.name as employee_name','p.id as project_id','p.project_name as project_name','activities.year as year',
      //jan
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=2,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) feb_com'),
      //mar
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=3,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) mar_com'),
      //apr
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=4,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) apr_com'),
      //may
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=5,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) may_com'),
      //jun
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=6,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) jun_com'),
      //jul
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=7,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) jul_com'),
      //aug
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=8,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) aug_com'),
      //sep
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=9,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) sep_com'),
      //oct
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=10,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) oct_com'),
      //nov
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=11,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) nov_com'),
      //dec
      ...
      DB::raw('if(sum(if(activities.from_otl=1 and month=12,task_hour,0))>0,sum(if(activities.from_otl=1 and month=1,task_hour,0)),sum(if(activities.from_otl=0 and month=1,task_hour,0))) dec_com')
      )
      ...
      ->where('activities.project_id','=',37)
      ->where('activities.year', '=', $year)

      ->groupBy('manager_id','manager_name','employee_id','employee_name','project_id','project_name','year')

      ;*/

      $activityList = DB::select('
      select u.id, name, project_name, year

      , sum(if(a.from_otl=0 and month=1,task_hour,0)) jan

      , sum(if(a.from_otl=1 and month=1,task_hour,0)) jan_otl

      , if(sum(if(a.from_otl=1 and month=1,task_hour,0))>0,sum(if(a.from_otl=1 and month=1,task_hour,0)),sum(if(a.from_otl=0 and month=1,task_hour,0))) jan_com

      , sum(if(a.from_otl=0 and month=6,task_hour,0)) jun

      , sum(if(a.from_otl=1 and month=6,task_hour,0)) jun_otl

      , if(sum(if(a.from_otl=1 and month=6,task_hour,0))>0,sum(if(a.from_otl=1 and month=6,task_hour,0)),sum(if(a.from_otl=0 and month=6,task_hour,0))) jun_com
      ...
      group by name, project_name, year
