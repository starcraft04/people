...
class ToolsController extends Controller
{
    ...
    public function listOfUsersSkills($cert)
    {
        $skillList = DB::table('skills')
          ->select('skill_user.id', 'skills.domain', 'skills.subdomain', 'skills.technology', 'skills.skill', 'm.name AS manager_name', 'u.email AS user_email', 'u.name AS user_name', 'u.region', 'u.country', 'u.job_role', 'u.employee_type', 'skill_user.rating', 'skills.id AS skill_id')
