    ...
    <div class="x_panel">
      ...
      <div class="x_content">
          <div class="row">
            ...
            3) Select under timeline the year and months you want, under dimension and measures, select what you see on the picture. Then under reports, at the right, click on the export to excel button.</BR><font color="red">!!!Attention, it is important to have the units in days!!!</font></BR><img src="{{ asset('/img/help/OTL_HELP_03_extract_to_excel.png') }}"></BR></BR></BR>
