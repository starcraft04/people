    ...
    <div class="x_panel">
      ...
      <div class="x_content">
          <div class="row">
            ...
            5) Look if you get any errors from the upload. The error shows the lines in the excel file where the software could not find a match for those OTL code and META pair in the database.</BR><img src="{{ asset('/img/help/OTL_HELP_07_results.png') }}"></BR></BR></BR>
          </div>
