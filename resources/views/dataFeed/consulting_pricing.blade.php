...
<div class="page-title">
  <div class="title_left">
    <h3>Consulting Pricing upload</h3>
  </div>
</div>
      ...
      <div class="x_content">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <div class="col-md-8">
                Download 
                <a href="{{ asset('/Samples/consulting_pricing_upload.csv') }}" style="text-decoration: underline;">this file</a> to get the structure needed.
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group {!! $errors->has('uploadfile') ? 'has-error' : '' !!} col-md-12">
              <div class="col-md-2">
                {!! Form::label('uploadfile', 'Pricing CSV file', ['class' => 'control-label']) !!}
              </div>
              <div class="col-md-10">
