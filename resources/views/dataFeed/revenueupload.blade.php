      ...
      <div class="x_content">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <div class="col-md-10">
                Download this
                <a href="{{ asset('/Samples/revenue_upload_sample.xls') }}">this file</a> to get the structure needed. The file needs to be named with the following convention:year.xls so for example for 2017, you need the file 2017.xls
              </div>
            </div>
          </div>
