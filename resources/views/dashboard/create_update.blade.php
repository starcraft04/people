...
<div class="box box-info">
  ...
  <div class="box-body">
    ...
    @if($action == 'create')
    {!! Form::open(['url' => 'dashboardFormCreate/'.$user_id, 'method' => 'post', 'class' => 'form-horizontal']) !!}
    @elseif($action == 'update')
    {!! Form::open(['url' => 'dashboardFormUpdate/'.$user_id.'/'.$project_id, 'method' => 'post', 'class' => 'form-horizontal']) !!}
    @endif
<div class="col-md-6">
    <div class="row">
