...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <!-- Window content -->
      <div class="x_content">
        <table id="projectTable_unassigned" class="table table-striped table-hover table-bordered mytable" width="100%">
          <thead>
            <tr>
              <th>ID</th>
              <th>Customer name</th>
  ...
  $(document).ready(function() {
    ...
    projectTable_unassigned = $('#projectTable_unassigned').DataTable({
      ...
      columns: [{
        ...
        {
          name: 'otl_project_code',
          data: 'otl_project_code',
          visible: false
        },
        {
          name: 'meta_activity',
        ...
        {
          name: 'gold_order_number',
          data: 'gold_order_number',
          visible: false
        },
        {
          name: 'product_code',
